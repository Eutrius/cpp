...
ScavTrap::ScavTrap(const ScavTrap &other) : ClapTrap()
{
    ...
    std::cout << "ScavTrap " << other.getName() << " is cloned." << std::endl;
}
...
ScavTrap &ScavTrap::operator=(const ScavTrap &other)
{
    ...
    _energy = other.getEnergy();
    _damage = other.getDamage();
    std::cout << "ScapTrap " << other.getName() << " is cloned." << std::endl;
    return (*this);
}

void ScavTrap::guardGate(void)
{
    std::cout << "ScapTrap " << _name << " is now in Gate Keeper mode." << std::endl;
}
